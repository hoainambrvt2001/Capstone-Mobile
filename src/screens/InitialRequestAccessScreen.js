...
import { Text, Button, Appbar, Divider } from "react-native-paper";
...
const InitialRequestAccessScreen = ({ navigation }) => {
    ...
    <>
      ...
      <ScrollView style={styles.wrapper}>
        ...
        >
          <Button
            mode="contained"
            style={{ backgroundColor: Colors.pink, width: "100%" }}
...
export default InitialRequestAccessScreen;
